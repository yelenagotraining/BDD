...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Jim calculates total cost of renting a venue with a random number of guests")]
        [Xunit.TraitAttribute("FeatureTitle", "Venue price calculator")]
        [Xunit.TraitAttribute("Description", "Jim calculates total cost of renting a venue with a random number of guests")]
